...
export function ImportPanel({ allowSample, animateEntry = false, autoFocusUpload, error, onImport, onRunSample, intro, confirmLabel }: ImportPanelProps) {
  ...
  if (pending) {
    ...
    return (
      <div className="wk wk-import" data-state="confirmed">
        ...
        <p className="wk-dim" style={{ fontSize: 15 }}>Reclaim read this file. Review it, then add it to the ledger.</p>
  ...
  return (
    <div className="wk wk-import" data-reveal={animateEntry}>
      ...
      <p className="wk-dim" style={{ fontSize: 15 }}>{intro}</p>
      ...
      <p className="wk-muted" style={{ display: 'flex', alignItems: 'center', gap: 9, fontSize: 13.5 }}>
              ...
              <tbody>
                {REQUIRED_COLUMNS.map((col) => (
                  <tr key={col.name} style={{ cursor: 'default' }}>
                    <td className="wk-num" style={{ fontSize: 13.5 }}>
                      {col.name}
                    </td>
                    <td className="wk-dim" style={{ fontSize: 14 }}>
                      {col.description}
                    </td>
                  </tr>
                ))}
