      ...
      <div className="wk-panelcard-body wk-stack">
        ...
        {!canEdit ? (
          <p className="wk-field-hint">
            ...
            <button type="button" className="wk-linklike" onClick={() => setUpgrade('Editable letters are part of Pro.')}>See what Pro adds</button>
          </p>
        ) : null}
        ...
        <div className="wk-actions">
          {isVendorLetter ? (
            <button type="button" className="wk-btn" data-variant="outline" data-size="sm" onClick={limits.aiDrafts ? draftWithAi : () => setUpgrade('AI recovery drafts are part of Pro.')} disabled={drafting || Boolean(amountError)}>
